...
# 定義自變量和應變量
X = data[['總日照時數h']].values  # 使用總日照時數作為自變量
...
plt.title('線性回歸: 總日照時數 vs 平均氣溫', fontproperties=font_properties)
...
output_path = r'C:\Users\lanvi\OneDrive\Documents\github\MLproject_Solar_Irradiance\temp_solar\linear_regression01.png'
